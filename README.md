...
1. The URL in fstab.yaml file will *always* follow the structure: https://guides.adobe.com/eds-workers/{your_github_user_name}/{git_repository_name}/{branch_name}/{root_folder_name}. {branch_name} and {root_folder_name} should be "main" and "docs" respectively.
